...
const features: Feature[] = [
    ...
    }, 
    {
        icon: PhoneIcon,
        label: "Phone System",
        description: "Inbound & outbound calling capabilties"
    }, 
    {
        icon: BookOpenIcon,
        label: "Knowledge Base",
        description: "Train AI on our documentation"
    }, 
...
const PremiumFeatureOverlay = ({children}:PremiumFeatureOverlayProps) => {
