...
const CustomizationForm = ({initialData, hasVapiPlugin}:CustomizationFormProps) => {
    ...
    const onSubmit = async(data: FormSchema) => {
        ...
        try {
            ...
            const vapiSettings = {
                assistantId: data.vapiSettings.assistantId === "none" ? "" : data.vapiSettings.assistantId, 
                phoneNumber: data.vapiSettings.phoneNumber === "none" ? "" : data.vapiSettings.phoneNumber, 
            }
