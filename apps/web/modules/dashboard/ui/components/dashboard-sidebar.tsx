...
import { Calendar, CreditCardIcon, InboxIcon, LayoutDashboardIcon, LibraryBigIcon, PaletteIcon, } from "lucide-react"
            ...
            <SidebarMenu>
                <SidebarMenuItem>
                    <UserButton showName appearance={{
                      elements: {
                          rootBox: "w-full! h-8!",
                          userButtonTrigger: "w-full! hover:bg-sidebar-accent! hover:text-sidebar-content-accent-foreground! group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2!",
